					...
					<div id='headerKanan'>
						...
						<span class='menuLogout' style='margin-top:40px; border:none;'><center id='menuLogout'><img id='user_logo'src="php/cetak_gambar.php">
							...
							<div id='menu_profile' class='hidden'>
								<center class='menu_logout'><a href="tentor-page.php"><span >Profile</span></a></center>
				...
				<div class="menucenter">
					<div id='isibio'>
						<?php 
							...
							include('phpform/menu-tentor.php');
						 ?>
					</div>
					<div class="menubio">
						<div id='user_profile'>
							<img id='profile_image' src="php/cetak_gambar.php">
							<center style="color:rgb(229, 182, 154)" "font-weight:bolder"><p id='profile_name'><?php echo $_SESSION['login_user']; ?></p></center>
						</div>
						...
						<div id='bgoption_deskripsi' class="optionbio bgoption hover">Deskripsi & Konfirmasi</div>
						<div id='option_deskripsi' class="optionbio hover">Deskripsi & Konfirmasi</div>
						...
						<div id='bgoption_jadwal' class="optionbio bgoption hover">Jadwal</div>
						<div id='option_jadwal' class="optionbio hover">Jadwal</div>
			...
			<div class="footer">
				<div>
					<center><h3 style="color:rgba(210, 137, 23, 1)">Contact us on : </h3></br>
						...
						<img src="images/phone.png" style="height:55px" title="0271-675231">
					</center>
