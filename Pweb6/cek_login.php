...
$nama = $_POST['nama']; // mengambil data nama dalam bentuk post
$email = $_POST['email']; // mengambil data email dalam bentuk post
$nim = $_POST['nim']; // mengambil data nim dalam bentuk post
$sql = "SELECT * FROM users WHERE id_user='$id_user' AND password='$pass' AND nama='$nama' AND email='$email' AND nim='$nim' "; // pilih data yang ada di dalam tabel user dimana id_user, password, email, nim berdasarkan data yang di dalam database
